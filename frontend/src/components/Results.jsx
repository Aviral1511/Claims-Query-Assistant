...
// export default function Results({ data, onSelect, selectedClaim, onCloseDetail }) {
//     if (!data) return null;

//     // Single-claim response (from exact CLM-#### lookup)
//     if (data.text && data.claim) {
//         const c = data.claim;
//         return (
//             <div className="p-3 border rounded">
...
//                             {/* Inline detail under the clicked row */}
//                             {selectedClaim && selectedClaim._id === it._id && (
//                                 <li className="ml-4 border-l border-gray-200 pl-4">
//                                     <ClaimDetail claim={selectedClaim} onClose={onCloseDetail} />
//                                 </li>
//                             )}
//                         </React.Fragment>
//                     ))}
